...
import { Bell, BarChart3, MessageSquare, DollarSign, ShieldCheck, Contact } from 'lucide-react';
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Next payment due: July 31, 2024</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-green-600">Paid</div>
            <p className="text-xs text-muted-foreground">
              Last payment: $1,200 on June 1, 2024
            </p>
