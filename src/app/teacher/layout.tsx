    ...
    <div className="min-h-screen w-full">
      <div className="hidden md:block">
        <SidebarProvider>
          ...
          <SidebarInset>
            <DashboardHeader userName={user?.displayName || 'Jessica Miller'} userRole="teacher" userEmail={user?.email || 'j.miller@campus.edu'} />
...
export default function TeacherLayout({ children }: { children: ReactNode }) {
  return <WithAuth><TeacherLayoutContent>{children}</TeacherLayoutContent></WithAuth>
}
