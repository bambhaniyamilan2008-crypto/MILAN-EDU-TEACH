     ...
     <div className="min-h-screen w-full">
      <div className="hidden md:block">
        <SidebarProvider>
          ...
          <SidebarInset>
            <DashboardHeader userName={user?.displayName || 'Alex Johnson'} userRole="student" userEmail={user?.email || 'alex.j@campus.edu'} />
...
export default function StudentLayout({ children }: { children: ReactNode }) {
  return <WithAuth><StudentLayoutContent>{children}</StudentLayoutContent></WithAuth>
}
